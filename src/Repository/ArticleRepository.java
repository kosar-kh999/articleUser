...
public class ArticleRepository {
    ...
    public void insertArticle(Article article) throws SQLException {
        ...
        Connection connection = DatabaseConnection.getConnection();
        String sql = "insert into article_tbl  (title,brief,content,creatDate,isPublished,userId)" +
                "values(?,?,?,?,?,?)";
        PreparedStatement preparedStatement = connection.prepareStatement(sql);
        ...
        preparedStatement.setInt(6,article.getUser_id().getIdUser();
    ...
    public List<Article> showArticle() throws SQLException {
        ...
        Connection connection = DatabaseConnection.getConnection();
        String sql = "Select title,brief from article_tbl where isPublishe = 1";
        PreparedStatement preparedStatement = connection.prepareStatement(sql);
